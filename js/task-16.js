...
//  всех жанров книг (свойство genres) из массива books, а в
...
//  ['приключения', 'историческое', 'фантастика',
...
// Для вычисления значения переменной allGenders
//  использован метод flatMap().
// Для вычисления значения переменной uniqueGenres
//  использован метод filter().
...
console.log(allGenres);// ['приключения', 'историческое', 'фантастика',
// 'мистика', 'ужасы', 'мистика', 'приключения'].
