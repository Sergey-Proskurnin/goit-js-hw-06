...
// Переменной getSortedFriends присвоена стрелочная функция
//  с параметром (users).
// В теле функции используется цепочка методов в правильном
//  порядке.
// Значение параметра users не изменяется.
// Вызов функции с указанным массивом пользователей возвращает
//  массив ['Adrian Cross', 'Aisha Tran', 'Briana Decker',
//   'Eddie Strong', 'Goldie Gentry', 'Jacklyn Lucas',
//    'Jordan Sampson', 'Linda Chapman', 'Marilyn Mcintosh',
//     'Naomi Buckner', 'Padilla Garrison', 'Sharron Pace',
//      'Solomon Fokes'].
...
// ['Adrian Cross', 'Aisha Tran', 'Briana Decker',
//   'Eddie Strong', 'Goldie Gentry', 'Jacklyn Lucas',
//    'Jordan Sampson', 'Linda Chapman', 'Marilyn Mcintosh',
//     'Naomi Buckner', 'Padilla Garrison', 'Sharron Pace',
//      'Solomon Fokes'].