// Задание
// Дополни функцию isEveryUserActive(users) так, чтобы она
//  проверяла все ли пользователи
//  сейчас активны (свойство isActive) и возвращала
//   true или false.

// Тесты
// Объявлена переменная isEveryUserActive
// Переменной isEveryUserActive присвоена стрелочная
